...
export async function up({ context }: { context: QueryInterface }): Promise<void> {
    await context.createTable('profiles', {
        ...
        status: { type: DataTypes.ENUM('available', 'busy', 'away', 'none'), allowNull: false, defaultValue: 'available' },
        theme: { type: DataTypes.ENUM('light', 'dark', 'system'), allowNull: false, defaultValue: 'system' },
