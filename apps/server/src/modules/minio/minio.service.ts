...
export class MinioService implements OnModuleInit {
    ...
    constructor(private readonly configService: ConfigService) {
        ...
        this.internalClient = new Client(this.createClientOptions(this.configService.getOrThrow<string>('MINIO_INTERNAL_ENDPOINT')));
        this.publicClient = new Client(this.createClientOptions(this.configService.getOrThrow<string>('MINIO_PUBLIC_ENDPOINT')));
    }
    ...
    async generatePresignedPutUrl(objectKey: string, contentType: string, expiresIn: number): Promise<string> {
        void contentType;
        return this.publicClient.presignedPutObject(this.bucket, objectKey, expiresIn);
    }
